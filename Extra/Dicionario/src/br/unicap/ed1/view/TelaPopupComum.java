...
public class TelaPopupComum extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        jbtFinalizar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/br/unicap/ed1/view/imgs/Confirma0.png"))); // NOI18N
        ...
        getContentPane().add(jbtFinalizar, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 80, 40, 40));

        ok.setIcon(new javax.swing.ImageIcon(getClass().getResource("/br/unicap/ed1/view/imgs/IconeV.png"))); // NOI18N
        getContentPane().add(ok, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 30, 40, 40));

        Exclamacao.setIcon(new javax.swing.ImageIcon(getClass().getResource("/br/unicap/ed1/view/imgs/Exclamacao.png"))); // NOI18N
        getContentPane().add(Exclamacao, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 30, 40, 40));
        ...
        getContentPane().add(lblMensagem, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 30, 250, 40));

        lblFundo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/br/unicap/ed1/view/imgs/FundoPopupComum.png"))); // NOI18N
        getContentPane().add(lblFundo, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 0, 370, 150));
